...
async function getAPIKeys(restaurantId) {
...
async function connectToBinWise(apiKey) {
    try {
...
async function connectToToast(apiKey) {
    try {
...
async function connectToOpenTable(apiKey) {
    try {

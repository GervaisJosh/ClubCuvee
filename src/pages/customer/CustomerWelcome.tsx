    ...
    return (
      <div className="min-h-screen bg-[#fdfaf7] dark:bg-black px-6 py-10 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300">Activating your membership...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#fdfaf7] dark:bg-black px-6 py-10 flex items-center justify-center">
        <Card className="max-w-md mx-auto p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Payment Processing Error</h1>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="p-8 mb-8 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="text-center p-6 bg-[#800020]/5 dark:bg-[#800020]/20 rounded-lg border border-[#800020]/20 dark:border-[#800020]/30">
            ...
            <div className="text-center p-6 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800/30">
        ...
        <Card className="p-8 mb-8 bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                <p className="font-semibold text-gray-900 dark:text-white mb-1">Profile Curation</p>
            ...
            <div className="flex items-start">
              ...
              <div>
                <p className="font-semibold text-gray-900 dark:text-white mb-1">First Shipment</p>
                <p className="text-gray-600 dark:text-gray-300">
            ...
            <div className="flex items-start">
              ...
              <div>
                <p className="font-semibold text-gray-900 dark:text-white mb-1">Member Dashboard</p>
                <p className="text-gray-600 dark:text-gray-300">
        ...
        {/* Member Benefits */}
        <Card className="p-8 mb-8 bg-gradient-to-br from-[#800020]/5 dark:from-[#800020]/20 to-[#800020]/10 dark:to-[#800020]/30">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Curated Selections</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Flexible Delivery</h3>
              <p className="text-sm text-gray-600 dark:text-gray-300">
        ...
        {/* Contact Support */}
        <div className="text-center mt-12 p-6 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">

        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  onChange={e => setFormData((prev: OnboardingFormData) => ({ ...prev, restaurantName: e.target.value }))}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={e => setFormData((prev: OnboardingFormData) => ({ ...prev, email: e.target.value }))}
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary"
                  required
                />
              </div>
          ...
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
              {MEMBERSHIP_TIERS.map((tier: MembershipTierOption) => (
                <div
                  key={tier.id}
                  ...
                  onClick={() => setFormData((prev: OnboardingFormData) => ({ ...prev, membershipTier: tier.id }))}
                >

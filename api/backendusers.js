...
// api/backendusers.ts
var backendusers_exports = {};
__export(backendusers_exports, {
  fetchBackendUserData: () => fetchBackendUserData
});
module.exports = __toCommonJS(backendusers_exports);
...
// api/backendusers.ts
var fetchBackendUserData = async (userId) => {
  try {
    const response = await axios_default.get(`/api/users/${userId}`);
...
mime-types/index.js:
   ...
   *)
*/
//# sourceMappingURL=backendusers.js.map
